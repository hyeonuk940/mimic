...
def run_random_forest(file_path, exclude_cols, target_col, use_grid_search=False, is_save=False, save_path='rf_model.pkl'):
    """
    Args:
    ...
    if use_grid_search:
        print("\n🌲 [모드: 그리드 서치 ON] 랜덤 포레스트 최적의 파라미터 탐색 중...")
        ...
        print("\n🚀 [모드: 그리드 서치 OFF] 기본 설정(나무 100개)으로 빠르게 실행합니다.")
